...
def get_totals(date_from=None, date_to=None, excl_date_to=False, track_id=None, track2_id=None, contact_id=None, acc_type=None, company_id=None):
...
class ReportTBDetails(Model):
    ...
    def get_report_data(self, ids, context={}):
        ...
        totals_begin_bs = get_totals(date_from=None, date_to=month_begin_date_to,
                                     track_id=track_id, track2_id=track2_id, contact_id=contact_id, acc_type="bs", company_id=company_id)
        totals_begin_pl = get_totals(date_from=year_date_from, date_to=month_begin_date_to,
                                     track_id=track_id, track2_id=track2_id, contact_id=contact_id, acc_type="pl", company_id=company_id)
        totals_period = get_totals(
            date_from=month_date_from, date_to=date_to, track_id=track_id, track2_id=track2_id, contact_id=contact_id, company_id=company_id)
        totals_ytd_bs = get_totals(
            date_from=None, date_to=date_to, track_id=track_id, track2_id=track2_id, contact_id=contact_id, acc_type="bs", company_id=company_id)
        totals_ytd_pl = get_totals(
            date_from=year_date_from, date_to=date_to, track_id=track_id, track2_id=track2_id, contact_id=contact_id, acc_type="pl", company_id=company_id)
