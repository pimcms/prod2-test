...
class ReportSuppInvoice(Model):
    _name = "report.supp.invoice"
    _transient = True
    _fields = {
    ...
    def get_report_data(self, ids, context={}):
        ...
        for r in res:
            vals = dict(r)
            if vals["reconcile_number"] and not str(vals["reconcile_number"]).endswith("*"):
                vals["due_amount"] = 0
            else:
        ...
        data = {
            ...
            "totals": {
                ...
                "amount_total": sum(l["total_amount"] for l in lines),
            }
        }
        return data

ReportSuppInvoice.register()
