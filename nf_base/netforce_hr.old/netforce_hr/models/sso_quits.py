...
class SsoQuits(Model):
    ...
    def write(self,ids,vals,**kw):
        obj=self.browse(ids)[0]
        get_model('sso.quits.line').delete([line.id for line in obj.lines])
    ...
    def onchange_employee(self,context={}):
        ...
        line["resign_date"] = emp.resign_date
        return data
    ...
    def onchange_month(self,context={}):
        ...
        for emp in emps:
            print(emp.hire_date)
            if emp.resign_date:
                emp_month = emp.resign_date[5:7]
                emp_year = emp.resign_date[0:4]
